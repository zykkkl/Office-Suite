...
def create_material3_light(seed_color: str = "#6750A4") -> Theme:
    ...
    return Theme(
        ...
        effects=ThemeEffects(
            ...
            radius_md=6,
            radius_lg=12,
            shadow_sm="0 1px 2px rgba(0,0,0,0.12)",
            shadow_md="0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)",
            shadow_lg="0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23)",
            border_width=1,
        ),
    )
...
def create_material3_dark(seed_color: str = "#6750A4") -> Theme:
    ...
    return Theme(
        ...
        effects=ThemeEffects(
            ...
            shadow_md="0 1px 3px rgba(0,0,0,0.4), 0 1px 2px rgba(0,0,0,0.6)",
            shadow_lg="0 3px 6px rgba(0,0,0,0.5), 0 3px 6px rgba(0,0,0,0.6)",
            border_width=1,
        ),
    )
